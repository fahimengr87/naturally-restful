...
- [ ] Best sleep supplements compared *(built as /best-sleep-supplements)*
- [ ] Best magnesium supplements for sleep, ranked
- [ ] Best ashwagandha supplements: what a COA should show
- [ ] Best natural sleep aids that aren't supplements (free guide → email bait)

## Cluster 5 — Situational long-tail (SEO entry points)
- [ ] Best supplements for shift workers trying to sleep
- [ ] Supplements for sleep anxiety (the 3 a.m. wake-up problem)
- [ ] What to take for jet lag: a timing table by flight direction
- [ ] Sleep supplements and antidepressants: the interaction checklist
- [ ] Do sleep gummies work, or is it the routine?
